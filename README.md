...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/posthog-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12896&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/posthog-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `posthog` can be installed with:

```
conda install posthog
```

It is possible to list all of the versions of `posthog` available on your platform with:
